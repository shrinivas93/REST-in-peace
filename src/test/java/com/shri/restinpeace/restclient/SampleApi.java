...
public interface SampleApi {
	...
	String foo(@PathParam("pathParam1") String x, @QueryParam(value = "queryParam1", required = true) Integer y,
			@HeaderParam(value = "headerParam1", required = true, defaultValue = "Covid") String val);

	@Deprecated
	String bar(@PathParam("pathParam1") String x, @QueryParam(value = "queryParam1", required = true) Integer y,
			@HeaderParam(value = "headerParam1", required = true, defaultValue = "Covid") String val);

	@GET("https://enaxsbw8ux2bb.x.pipedream.net/{pathParam1}")
	@PUT("https://enaxsbw8ux2bb.x.pipedream.net/{pathParam1}")
	String foobar(@PathParam("pathParam1") String x, @QueryParam(value = "queryParam1", required = true) Integer y,
			@HeaderParam(value = "headerParam1", required = true, defaultValue = "Covid") String val);
