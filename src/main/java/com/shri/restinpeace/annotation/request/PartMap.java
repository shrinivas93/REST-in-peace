 ...
 * part named after the entry's key. A {@code null} map or a {@code null}
 * entry value is skipped, not an error. Combines with fixed {@code @Part}
 * parameters on the same method; only valid alongside {@code @Multipart}.
 */
@Documented
